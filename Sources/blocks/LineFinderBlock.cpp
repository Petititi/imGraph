...
namespace charliesoft
{
  ...
  ADD_PARAMETER(true, Mat, "BLOCK__LINE_FINDER_IN_IMAGE", "BLOCK__LINE_FINDER_IN_IMAGE_HELP");
  END_BLOCK_PARAMS();

  BEGIN_BLOCK_OUTPUT_PARAMS(LineFinerBlock);
  ADD_PARAMETER(true, Mat, "BLOCK__LINE_FINDER_OUT_IMAGE", "BLOCK__LINE_FINDER_OUT_IMAGE_HELP");
  END_BLOCK_PARAMS();
