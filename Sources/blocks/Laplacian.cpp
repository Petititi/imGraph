...
namespace charliesoft
{
	...
	ADD_PARAMETER(true, Matrix, "BLOCK__LAPLACIAN_IN_IMAGE", "BLOCK__LAPLACIAN_IN_IMAGE_HELP");
	END_BLOCK_PARAMS();

	BEGIN_BLOCK_OUTPUT_PARAMS(Laplacian);
	ADD_PARAMETER(true, Matrix, "BLOCK__LAPLACIAN_OUT_IMAGE", "BLOCK__LAPLACIAN_OUT_IMAGE_HELP");
	END_BLOCK_PARAMS();
