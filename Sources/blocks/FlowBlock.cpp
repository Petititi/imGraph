...
namespace charliesoft
{
  ...
  ADD_PARAMETER(toBeLinked, Matrix, "BLOCK__OPTICFLOW_IN_IMAGE1", "BLOCK__OPTICFLOW_IN_IMAGE1_HELP");
  ADD_PARAMETER(toBeLinked, Matrix, "BLOCK__OPTICFLOW_IN_IMAGE2", "BLOCK__OPTICFLOW_IN_IMAGE2_HELP");
  ...
  ADD_PARAMETER(toBeLinked, Matrix, "BLOCK__OPTICFLOW_OUT_IMAGE", "BLOCK__OPTICFLOW_OUT_IMAGE_HELP");
  END_BLOCK_PARAMS();
