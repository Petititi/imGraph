...
public:
  ...
  ADD_PARAMETER(userConstant, FilePath, "BLOCK__INPUT_IN_INPUT_FILE", "BLOCK__INPUT_IN_INPUT_FILE_HELP");
  ...
  ADD_PARAMETER(toBeLinked, Matrix, "BLOCK__INPUT_OUT_IMAGE", "BLOCK__INPUT_OUT_IMAGE_HELP");
  ADD_PARAMETER(userConstant, Int, "BLOCK__INPUT_INOUT_WIDTH", "BLOCK__INPUT_INOUT_WIDTH_HELP");
  ADD_PARAMETER(userConstant, Int, "BLOCK__INPUT_INOUT_HEIGHT", "BLOCK__INPUT_INOUT_HEIGHT_HELP");
  ADD_PARAMETER(userConstant, Int, "BLOCK__INPUT_INOUT_POS_FRAMES", "BLOCK__INPUT_INOUT_POS_FRAMES_HELP");
  END_BLOCK_PARAMS();
