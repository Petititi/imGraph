...
namespace charliesoft
{
  ...
  ADD_PARAMETER(false, Int, "BLOCK__CROP_IN_WIDTH", "BLOCK__CROP_IN_WIDTH_HELP");
  ADD_PARAMETER(false, Int, "BLOCK__CROP_IN_HEIGHT", "BLOCK__CROP_IN_HEIGHT_HELP");
  ...
  bool BlockCrop::run(){
    ...
    if (!mat.empty())
    {
      ...
      if (!myInputs_["BLOCK__CROP_IN_WIDTH"].isDefaultValue())
        filter.set("width",
        myInputs_["BLOCK__CROP_IN_WIDTH"].get<int>());
      if (!myInputs_["BLOCK__CROP_IN_HEIGHT"].isDefaultValue())
        filter.set("height",
        myInputs_["BLOCK__CROP_IN_HEIGHT"].get<int>());
