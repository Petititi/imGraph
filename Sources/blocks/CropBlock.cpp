...
namespace charliesoft
{
  ...
  ADD_PARAMETER(toBeLinked, Matrix, "BLOCK__CROP_IN_IMAGE", "BLOCK__CROP_IN_IMAGE_HELP");
  ADD_PARAMETER(userConstant, Int, "BLOCK__CROP_WIDTH", "BLOCK__CROP_WIDTH_HELP");
  ADD_PARAMETER(userConstant, Int, "BLOCK__CROP_HEIGHT", "BLOCK__CROP_HEIGHT_HELP");
  ADD_PARAMETER(userConstant, Int, "BLOCK__CROP_IN_X", "BLOCK__CROP_IN_X_HELP");
  ADD_PARAMETER(userConstant, Int, "BLOCK__CROP_IN_Y", "BLOCK__CROP_IN_Y_HELP");
  END_BLOCK_PARAMS();

  BEGIN_BLOCK_OUTPUT_PARAMS(BlockCrop);
  ADD_PARAMETER(toBeLinked, Matrix, "BLOCK__CROP_OUT_IMAGE", "BLOCK__CROP_OUT_IMAGE_HELP");
...
public:
  ...
  //Add parameters, with following parameters:
  //default visibility, type of parameter, name (key of internationalizor), helper...
  ADD_PARAMETER(toBeLinked, Matrix, "BLOCK__RESIZEMATRIX_IN_IMG", "BLOCK__RESIZEMATRIX_IN_IMG_HELP");
  ...
  ADD_PARAMETER(toBeLinked, Matrix, "BLOCK__RESIZEMATRIX_OUT_IMAGE", "BLOCK__RESIZEMATRIX_OUT_IMAGE_HELP");
  END_BLOCK_PARAMS();
