...
protected:
    ...
    ADD_PARAMETER_FULL(userConstant, Int, "BLOCK__CASCADECLASSIFIER_IN_MIN_WIDTH", "BLOCK__CASCADECLASSIFIER_IN_MIN_WIDTH_HELP", 30);
    ADD_PARAMETER_FULL(userConstant, Int, "BLOCK__CASCADECLASSIFIER_IN_MIN_HEIGHT", "BLOCK__CASCADECLASSIFIER_IN_MIN_HEIGHT_HELP", 30);
