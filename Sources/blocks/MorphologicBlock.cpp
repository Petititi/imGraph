...
namespace charliesoft
{
  ...
  ADD_PARAMETER(toBeLinked, Matrix, "BLOCK__MORPHOLOGIC_IN_IMAGE", "BLOCK__MORPHOLOGIC_IN_IMAGE_HELP");
  ...
  ADD_PARAMETER(toBeLinked, Matrix, "BLOCK__MORPHOLOGIC_OUT_IMAGE", "BLOCK__MORPHOLOGIC_OUT_IMAGE_HELP");
  END_BLOCK_PARAMS();
