...
namespace charliesoft
{
  ...
  ADD_PARAMETER(false, Matrix, "BLOCK__MORPHOLOGIC_ELEMENT", "BLOCK__MORPHOLOGIC_ELEMENT_HELP");
  ADD_PARAMETER(false, ListBox, "BLOCK__MORPHOLOGIC_OPERATOR", "BLOCK__MORPHOLOGIC_OPERATOR_HELP");
