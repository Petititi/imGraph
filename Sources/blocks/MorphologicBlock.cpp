...
namespace charliesoft
{
  ...
  ADD_PARAMETER(true, Mat, "BLOCK__MORPHOLOGIC_IN_IMAGE", "BLOCK__MORPHOLOGIC_IN_IMAGE_HELP");
  ADD_PARAMETER(false, Mat, "BLOCK__MORPHOLOGIC_ELEMENT", "BLOCK__MORPHOLOGIC_ELEMENT_HELP");
  ADD_PARAMETER(false, Int, "BLOCK__MORPHOLOGIC_OPERATOR", "BLOCK__MORPHOLOGIC_OPERATOR_HELP");
  ADD_PARAMETER(false, Int, "BLOCK__MORPHOLOGIC_ITERATIONS", "BLOCK__MORPHOLOGIC_ITERATIONS_HELP");
  END_BLOCK_PARAMS();

  BEGIN_BLOCK_OUTPUT_PARAMS(MorphoBlock);
  ADD_PARAMETER(true, Mat, "BLOCK__MORPHOLOGIC_OUT_IMAGE", "BLOCK__MORPHOLOGIC_OUT_IMAGE_HELP");
  END_BLOCK_PARAMS();
