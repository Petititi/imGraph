...
macro(begin_new_project name)
	...
	set(file_list_ ${files_srcs} ${files_int_hdrs} ${files_QWT_srcs} ${files_blocks_srcs} ${files_blocks_int_hdrs} ${files_view_srcs} ${files_view_int_hdrs} ${cfg_file} )
	if( DEFINED HEADERS_MOC )
		set(file_list_ ${file_list_} ${HEADERS_MOC})
        source_group("Include\\moc" FILES ${files_int_hdrs} ${SRC_BLOCKS})
		MESSAGE(STATUS "HEADERS_MOC : ${HEADERS_MOC}")
	endif( )
	if( DEFINED SRC_BLOCKS )
		set(file_list_ ${file_list_} ${SRC_BLOCKS})
        source_group("Include" FILES ${files_int_hdrs} ${SRC_BLOCKS})
	endif( )
	if( DEFINED _RCC_OUTFILES )
		set(file_list_ ${file_list_} ${_RCC_OUTFILES})
        source_group("Src\\moc" FILES ${SRC_BLOCKS})
